...
namespace OFProxy.classes
{
    public class ProxyController : IDisposable
    {
        ...
        public void StartProxy()
        {
            ...
            explicitEndPoint = new ExplicitProxyEndPoint(IPAddress.Any, this._port);
        ...
        public void Stop()
        {
            ...
            {
                //Nothing: This is just to revent errors on stopping an already stopped proxy
            }
        }
        ...
        {
            //We're doing NOTHING now we're a library
